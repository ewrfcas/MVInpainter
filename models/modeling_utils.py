    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        if from_flax:
            ...
            if low_cpu_mem_usage:
                ...
                if "add_model_cfg" in unused_kwargs and unused_kwargs['add_model_cfg'] is not None:
                    for key in unused_kwargs['add_model_cfg']:
                        config[key] = unused_kwargs['add_model_cfg'][key]
                model = cls.from_config(config, **unused_kwargs)
